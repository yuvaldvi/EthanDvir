...
(function () {
  ...
  // ---------- inject SIDE RAILS (desktop) ----------
  var railL = document.createElement('div');
  railL.className = 'siderail left';
  railL.innerHTML =
    '<span class="tick">ED</span>' +
    '<span class="vt accent">Ethan Dvir &mdash; GT Driver</span>' +
    '<span class="dot"></span>';
  var railR = document.createElement('div');
  railR.className = 'siderail right';
  railR.innerHTML =
    '<span class="vt">Est. 2024</span>' +
    '<a class="vt" href="https://www.instagram.com/ethandvir/" target="_blank" rel="noopener">Instagram @ethandvir</a>' +
    '<span class="vt">British &middot; in Spain</span>';
